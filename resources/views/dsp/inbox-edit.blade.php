...
@section('title', 'Редактирование - Входящий ДСП')
@section('description', '')
@section('keywords', '')
        ...
        <div id='content'>
            ...
            <div class='panel panel-default'>
                ...
                <div class='panel-body'>
                    ...
                    {!! Form::model($entity, ['route' => ['dsp.inbox.save', $entity->id], 'id'=>'inbox_dsp_form'])!!}
                    ...
                    <div class="form-actions">
                        @if(App::make('authentication_helper')->hasPermission(array("_superadmin")) || App::make('authenticator')->getLoggedUser()->id == $entity->author_id)
                            <button id="save_inbox_dsp" class="btn btn-default save_inbox_dsp">Сохранить</button>
                            <button id="save_close_inbox_dsp" class="btn btn-default save_close_inbox_dsp">Сохранить и закрыть</button>
                        @endif
