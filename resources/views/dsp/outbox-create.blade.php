...
@section('title', 'Создание - Исходящий ДСП')
@section('description', '')
@section('keywords', '')
...
@section('toolsbar')
    @if(App::make('authentication_helper')->hasPermission(array("_superadmin", "_dsp-outbox-create")))
        ...
        &nbsp;
        <a class='btn btn-danger' data-toggle='toolbar-tooltip' href='{{ route('dsp.outbox.cancel', ['id'=>$id]) }}' title='Закрыть'>
          ...
          <div class='panel-body'>
            ...
            {!! Form::open(['route' => 'dsp.outbox.create' , 'files'=> 'true', 'id'=>'outbox_dsp_form', 'name'=>'outbox_dsp_form'])!!}
              ...
              <div class="form-actions">
                  ...
                  <button id="save_close_outbox_dsp" class="btn btn-default">Сохранить и закрыть</button>
                  <a id='cancelBtn' class="btn" href="{{ route('dsp.outbox.cancel', ['id'=>$id]) }}">Отмена</a>
              </div>
