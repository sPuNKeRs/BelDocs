        ...
        <div class='panel panel-default'>
          ...
          <div class='panel-body'>
            ...
            {!! Form::open(['route' => 'dsp.inbox.save' , 'files'=> 'true', 'id'=>'inbox_dsp_form', 'name'=>'inbox_dsp_form'])!!}
              ...
              {!! Form::hidden('dsp_num', $last_inbox_dsp_num+1, ['id'=>'dsp_num']) !!}
              ...
              <div class="row">
                  <div class="col-md-2">
                      @include('widgets.form._formitem_text', ['value' => $last_inbox_dsp_num+1,'name' => 'entity_num', 'title' => 'Номер', 'placeholder' => 'Номер'])
                  </div>
                  <div class="col-md-2">
