...
@section('title', 'Просмотр - Исходящий ДСП')
@section('description', '')
@section('keywords', '')
        ...
        <div id='content'>
            ...
            <div class='panel panel-default'>
                ...
                <div class='panel-body'>
                    ...
                    {!! Form::model($entity, ['id'=>'outbox_dsp_form'])!!}
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            @include('widgets.form._formitem_text', ['name' => 'title', 'title' => 'Тема', 'placeholder' => 'Тема ДСП', 'readonly' => 'true' ])
                        </div>
                        <div class="col-md-3">
