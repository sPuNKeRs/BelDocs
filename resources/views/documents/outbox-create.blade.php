...
@section('title', 'Создание - Исходящий приказ')
@section('description', '')
@section('keywords', '')
...
@section('toolsbar')
    @if(App::make('authentication_helper')->hasPermission(array("_superadmin", "_orders-outbox-create")))
        ...
        &nbsp;
        <a class='btn btn-danger' data-toggle='toolbar-tooltip' href='{{ route('orders.outbox.cancel', ['id'=>$id]) }}' title='Закрыть'>
      ...
      <div id='content'>
        ...
        <div class='panel panel-default'>
          <div class='panel-heading'>
            ...
            Форма создание исходящего приказа
          ...
          <div class='panel-body'>
            ...
            {!! Form::open(['route' => 'orders.outbox.create' , 'files'=> 'true', 'id'=>'outbox_order_form', 'name'=>'outbox_order_form'])!!}
              ...
              <div class="form-actions">
                  ...
                  <button id="save_close_outbox_order" class="btn btn-default">Сохранить и закрыть</button>
                  <a id='cancelBtn' class="btn" href="{{ route('orders.outbox.cancel', ['id'=>$id]) }}">Отмена</a>
              </div>
