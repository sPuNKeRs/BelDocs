...
@section('title', 'Создание - Исходящий документ')
@section('description', '')
@section('keywords', '')
...
@section('toolsbar')
    @if(App::make('authentication_helper')->hasPermission(array("_superadmin", "_documents-outbox-create")))
        ...
        &nbsp;
        <a class='btn btn-danger' data-toggle='toolbar-tooltip' href='{{ route('documents.outbox.cancel', ['id'=>$id]) }}' title='Закрыть'>
      ...
      <div id='content'>
        ...
        <div class='panel panel-default'>
          <div class='panel-heading'>
            ...
            Форма создание исходящего документа
          ...
          <div class='panel-body'>
            ...
            {!! Form::open(['route' => 'documents.outbox.create' , 'files'=> 'true', 'id'=>'outbox_document_form', 'name'=>'outbox_document_form'])!!}
              {!! Form::hidden('id', $id, ['id'=>'entity_id']) !!}
              {!! Form::hidden('slug', $slug, ['id'=>'slug']) !!}
              {!! Form::hidden('doc_num', $last_outbox_document_num+1, ['id'=>'doc_num']) !!}
              ...
              <div class="row">
                  <div class="col-md-2">
                      @include('widgets.form._formitem_text', ['value' => $last_outbox_document_num+1,'name' => 'entity_num', 'title' => 'Номер', 'placeholder' => 'Номер'])
                  </div>
                  <div class="col-md-2">
              ...
              <div class="form-actions">
                  ...
                  <button id="save_close_outbox_document" class="btn btn-default">Сохранить и закрыть</button>
                  <a id='cancelBtn' class="btn" href="{{ route('documents.outbox.cancel', ['id'=>$id]) }}">Отмена</a>
              </div>
