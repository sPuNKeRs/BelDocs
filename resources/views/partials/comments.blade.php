                ...
                <div class="media" id="comment_{{$comment->id}}">
                    <a class="pull-left" href="#">
                        <img class="media-object" width="64px"
                             src="{!! $comment->user_profile->presenter()->avatar() !!}">
                    </a>
                    @if(App::make('authentication_helper')->hasPermission(array("_superadmin")) || App::make('authenticator')->getLoggedUser()->id == $comment->author_id)
                        <i class="fa fa-minus-circle pull-right fa-lg delete-comment" style="margin-top: 10px;"
                           aria-hidden="true" data-comment-id="{{$comment->id}}"></i>
                    @endif
